package com.kuangshi.autoControl.bean;
...
//	}
	...
	@Override
	public String toString() {
		return "ComponentInfo [packageInfo=" + packageInfo + ", componentName="
				+ componentName + ", intentFilters="
				+ Arrays.toString(intentFilters) + ", componentLabel="
				+ componentLabel + ", priority=" + priority
